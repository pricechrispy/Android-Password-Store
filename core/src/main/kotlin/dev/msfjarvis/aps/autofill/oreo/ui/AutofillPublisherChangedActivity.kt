...
import dev.msfjarvis.aps.autofill.oreo.AutofillPublisherChangedException
import dev.msfjarvis.aps.databinding.ActivityOreoAutofillPublisherChangedBinding
import dev.msfjarvis.aps.utils.viewBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(binding) {
            ...
            resetButton.setOnClickListener {
                ...
                val fillResponse = intent.getParcelableExtra<FillResponse>(dev.msfjarvis.aps.autofill.oreo.ui.AutofillPublisherChangedActivity.EXTRA_FILL_RESPONSE_AFTER_RESET)
